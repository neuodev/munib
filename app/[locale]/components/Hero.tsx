    ...
    return (
        <section className="hero__section bg-main">
            <div className="container__hero min-h-[calc(100vh-80px)] w-full bg-main flex justify-center items-center flex-col px-4 py-8 pt-20">
                <div className="flex flex-col justify-center items-center scale-80 sm:scale-100 md:scale-120 lg:scale-140 xl:scale-160">
                ...
                <div className="btns flex gap-2 mt-3 ">
                    <Link href="#contact" className="bg-white  hover:bg-third hover:text-white transition-all  px-6 py-3 text-main font-bold rounded text-center">{t('contactBtn')}</Link>
                    <Link href="#plans" className="text-white hover:decoration-1  transition-all px-6 py-3 font-bold rounded text-center">{t('plansBtn')}</Link>
                </div>
                </div>
            </div>
        </section>
