...
function ReviewCard({ name, location, rating, text, isRTL }: (typeof reviews)[0]) {
  ...
  return (
    <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex flex-col gap-2 hover:shadow-md transition-all duration-300 h-fit hover:scale-105 ">
